...
if __name__ == "__main__":
  ...
  #--------CALIBRATION DU CAPTEUR FORCE----------------
    ...
    psth2.loadDataFromDir("_","hz") # fournir (préfixe, sufixe) entourant la valeure de stim introduite dans fichier !!! doit changer nom de fonction si
    ...
    psth2.peak2peakFrequence("")  # fournir : (le fichier où est sauvegardé la figure ou rien(""))
    psth2.courbeRecrutementFrequence([0, 0.2], "Peak to peak","")
    psth2.fromChannel2PsthRectEmg(0.05, 0.2, 1, 2, OnePulsePerEvent = True)
    psth2.showAllPsthFrequence("")
    psth2.courbeRecrutementFrequence([0, 0.2], "EMG rectifie","")
    psth2.fromChannel2PsthForce(0.05, 0.2, 3, 2, OnePulsePerEvent = True)
    psth2.showAllPsthFrequence("")
    psth2.courbeRecrutementFrequence([0, 0.2], "Force","")#
